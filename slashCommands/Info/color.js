  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    let color = options.getString("color");
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:arrow:997461697231061092> **Name**', json.name, true)
        .addField("<:arrow:997461697231061092> **Hex**", json.hex, true)
        .addField("<:arrow:997461697231061092> **RGB**", json.rgb, true)
        .addField(`<:arrow:997461697231061092> **${client.la[ls].cmds.info.color.brightershade}**`, json.brightened, true)
