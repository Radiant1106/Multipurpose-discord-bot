...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      .addField("**CURRENT INVITES:**", `<:Like:997459408374222878> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
      ...
      async function menuselection(menu) {
        ...
        await menu?.reply({embeds : [new MessageEmbed()
          ...
          message.reply({embeds : [new MessageEmbed()
            ...
            .addField("\u200b", `<:Like:997459408374222878> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
