        ...
        if (args[0].toLowerCase() === "start") {
            try{
                ...
                let options = {
                    ...
                    prize: `<a:Gift:997466543447347251> ${giveawayPrize} <a:Gift:997466543447347251>`,
                    ...
                    bonusEntries: [],
                    messages: {
                        inviteToParticipate: "***React with <a:Tada_Yellow:997467033665015890> to participate!***\n",
                        drawing: "> Ends: {timestamp}\n",
                        hostedBy: "**Hosted by:** {this.hostedBy}",
                        dropMessage: "Be the first to react with <a:Tada_Yellow:997467033665015890>",
                        noWinner: "\n**Giveaway cancelled!**\n> No valid participations. :cry:",
                        endedAt: "Ends at", 
                        giveaway: '<a:Tada_Yellow:997467033665015890> **GIVEAWAY STARTED** <a:Tada_Yellow:997467033665015890>',
                        giveawayEnded: '<a:Tada_Green:992602192915742860> **GIVEAWAY ENDED** <a:Tada_Green:992602192915742860>',
            ...
            client.giveawaysManager.reroll(giveaway.messageId, { winnerCount: !isNaN(args[1]) ? Number(args[1]) : 1})
                ...
                .catch((e) => {
                    if (e.startsWith(`Giveaway with message Id ${giveaway.messageId} is not ended.`)) {
                        ...
                        console.error(e);
                        message.reply({content : '<a:no:1005793164046630912> **An error occured...**```' + String(e.message).substring(0, 1900) + "```"});
                    }
                });
