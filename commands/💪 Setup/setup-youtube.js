    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Youtube-Poster', 'https://cdn.discordapp.com/emojis/997460775742488708.png?size=128', 'https://discord.cyberneticsdev.tk')
