    ...
    try {
      ...
      async function first_layer() {
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Twitter Setup', 'https://cdn.discordapp.com/emojis/840255600851812393.png?size=96', 'https://discord.cyberneticsdev.tk')
...
/**
 * @INFO
 * Bot Coded by Radiant#1106| https://github?.com/CyberneticsDev/discord-js-lavalink-Music-Bot-erela-js
 * @INFO
