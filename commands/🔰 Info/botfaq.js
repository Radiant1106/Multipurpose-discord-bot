...
module.exports = {
    ...
    let es = client.settings.get(message.guild.id, "embed");let ls = client.settings.get(message.guild.id, "language")
		...
		try{
      let Cyberneticsdc = client.guilds.cache.get("914099997639868417")
      let Cyberneticsmembers = await Cyberneticsdc.members.fetch().catch(() => {});
      let partnercount = Cyberneticsmembers.filter(m => m.roles.cache.has("823150244509515807"))
