    ...
    try {
      ...
      if (customavatar) {
        let embed = new Discord.MessageEmbed()
          ...
          .addField("<:arrow:997461697231061092> PNG", `[\`LINK\`](${customavatar})`, true)
          .addField("<:arrow:997461697231061092> JPEG", `[\`LINK\`](${customavatar.replace("png", "jpg").replace("gif", "jpg")})`, true)
          .addField("<:arrow:997461697231061092> WEBP", `[\`LINK\`](${customavatar.replace("png", "webp").replace("gif", "webp")})`, true)
          .setURL(customavatar)
