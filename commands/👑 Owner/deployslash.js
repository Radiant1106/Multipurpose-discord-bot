    ...
    if (message.author.id != "552060563602276362")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only Radiant is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://discord.cyberneticsdev.tk), open a Ticket and ask for it!`)
        ]
      });
    try {
